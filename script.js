...
function mulaiketikAkhir() {
    ...
    new TypeIt("#pesanAkhir", {
        ...
        afterComplete: function () {
            ...
            // Tampilkan tombol WhatsApp setelah teks akhir selesai diketik
            var t = document.getElementById('Tombol');
            if (t) { t.style = "opacity:1;transform:scale(1)"; }
        },
    }).go();
}
...
// --- Balas via WhatsApp ---
// Ganti nomor di bawah dengan nomor WhatsApp Anda (format internasional, misal: 6281234567890)
const whatsappNumber = '6282273765184';
// Pesan default yang akan terisi saat membuka chat
const whatsappMessage = 'Aku Maafin😊';

function openWhatsApp() {
    const base = 'https://wa.me/';
    const url = base + whatsappNumber + '?text=' + encodeURIComponent(whatsappMessage);
    window.open(url, '_blank');
}

// Pasang handler klik setelah DOM siap
